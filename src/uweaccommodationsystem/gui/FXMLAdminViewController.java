...
import uweaccommodationsystem.gui.UWEAccommodationSystemGUI;
...
public class FXMLAdminViewController implements Initializable {
    ...
    @FXML
    private TextField txtNumOfRooms;
    ...
    public void initialize(URL url, ResourceBundle rb) 
    {
        ...
        txtCleaningStatus.setEditable(false);
        txtRoomType.setEditable(false);
        ...
        txtNumOfRooms.setEditable(false);
    ...
    // logout button swaps between user scenes 
    @FXML
    ...
    // allows the user to submit a lease with the studennt name,number,lease ID and lease length
    @FXML
    ...
    private void populateTable() 
    {
        ...
        for (Hall hall : uweAccommodationSystem.getHalls())
        {
            ...
            for (Room room : rooms) {
                ...
                String leaseNumber= "";
                String leaseLength= "";
                txtNumOfRooms.setText(String.valueOf(room.getTotalNumOfRooms()));
    ...
    private void tblRoomViewClicked(MouseEvent event) 
    {
        ...
        if (roomRow != null) {
            ...
            txtCleaningStatus.setText(room.getCleaningStatus());
